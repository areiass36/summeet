...
<template>
	...
	<article v-if="screen.isMobile" class="btns">
		<v-btn class="up" icon="fa-solid fa-arrow-up"  @touchstart="keys.press(ActionKeys.Up)" @touchend="keys.release(ActionKeys.Up)"/>
		<v-btn class="right" icon="fa-solid fa-arrow-right"  @touchstart="keys.press(ActionKeys.Right)" @touchend="keys.release(ActionKeys.Right)"/>
		<v-btn class="left" icon="fa-solid fa-arrow-left"  @touchstart="keys.press(ActionKeys.Left)" @touchend="keys.release(ActionKeys.Left)"/>
	    <v-btn class="down" icon="fa-solid fa-arrow-down"  @touchstart="keys.press(ActionKeys.Down)" @touchend="keys.release(ActionKeys.Down)"/>
	</article>
</template>
